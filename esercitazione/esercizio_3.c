...
creare due liste chimata produzione_reparto1 e produzione_reparto2
predisporre una funzione per aggiungere i dipendenti nella lista1 e nella lista2
predisporre una funzione che passata la lista e il' id il nuemro del giorno e il numero di pezzi prodotti, setti su quell' operaio il suo resoconto giornaliero di produzione
